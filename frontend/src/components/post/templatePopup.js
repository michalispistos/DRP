    ...
    render() { 
        return (this.props.trigger) ? (
            <div data-testid='popup' className="template-popup">
                <div className="template-popup-inner">
                    
                    Number of people currently in the team:<br/>
                    <input type="text"  maxLength="50" style={{width:"60%"}}
                    ...
                    <textarea className="text-area" type="text"  maxLength="255" style={{width:"60%"}}
                    onChange={(e) => {this.handleAbout(e)}} /><br/>

                    <button className="normal-button" type="button" style={{display: "block", float:"right", marginTop:"-2.5%"}} onClick={() => this.handleClick()}>Submit</button><br/>
